...
## 🧠 PART 4 (301–400) — **DB, SQL, OS, Networking (REAL CODE + TRAPS)**

> 🔥 Every MCQ has **code or query**
> 🔥 Focus on **deadlocks, isolation, race conditions, sockets, JDBC traps**
> 🔥 Very common in **senior backend interviews**

---

# 🗄️ DATABASE + SQL (CODE-BASED)
...
Executed concurrently without lock → causes?
...
Another transaction inserts new row → problem?
...
# 🧵 OPERATING SYSTEM (CODE / LOGIC)

### 311. (Deadlock)

```text
T1 holds R1 → waits R2
T2 holds R2 → waits R1
```
...
If you want **Spring Boot–heavy** or **System Design oriented**, tell me before PART 5 and I’ll tune it.
